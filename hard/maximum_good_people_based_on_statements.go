...
//
// You are given a 0-indexed 2D integer array statements of size n x n that represents the statements
// made by n people about each other. More specifically, statements[i][j] could be one of the following:
//
...
//
// Example 1:
// Image location: [/image/hard/maximum_good_people_based_on_statements_1.png]
...
//
// Example 2:
// Image location: [/image/hard/maximum_good_people_based_on_statements_2.png]
